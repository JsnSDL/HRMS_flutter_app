...
import 'package:hrm_employee/Screens/Admin%20Dashboard/Project%20managment/project_details.dart';
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      List<Project> fetchedProjects = projectRecords.map((record) {
        return Project(
          name: record['project'],
          completed: record['completed'] ?? 40, // Ensure proper handling if 'completed' is missing
          pending: record['pending'] ?? 60,   // Ensure proper handling if 'pending' is missing
          description: record['description'],
          taskAssigner: '', // You can modify this based on your data structure
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: project.teamMembers.map((member) => Text(member)).toList(),
            ),
          ],
        ),
      ),
